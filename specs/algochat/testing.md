...
- `REQ-algochat-002`: `test_cross_impl.py`, `test_models.py`, `test_psk.py`, and `test_vectors.py`.
...
- `REQ-algochat-005`: the Fledge `verify` lane runs lifecycle validation, Ruff, and Pytest.
